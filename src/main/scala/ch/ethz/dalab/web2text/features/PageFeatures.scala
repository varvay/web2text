...
case class PageFeatures(
  ...
  override def toString = List(
    ...
    "++ Block features ++",
    "++++++++++++++++++++\n",
    (blockFeatureLabels.toIterator zip Source.fromString(blockFeatures.toString).getLines())
      map { case (lab, feat) => lab + "  " + feat} mkString "\n",
    "\n++++++++++++++++++++",
    "++ Edge features  ++",
    "++++++++++++++++++++\n",
    (edgeFeatureLabels.toIterator zip Source.fromString(edgeFeatures.toString).getLines())
      map { case (lab, feat) => lab + "  " + feat} mkString "\n"
  ) mkString "\n"
